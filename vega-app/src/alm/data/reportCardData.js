...
const REPORT_CARD_DATA = {
  ...
  periods: [
    ...
    // ══════════════════════════════════════════════
    // FEBRUARY 2026  (real QuickBooks data)
    // Source: Budget vs Actuals FY26 P&L reports
    // ══════════════════════════════════════════════
    {
      month: 'February',
      ...
      homes: [
        {
          ...
          beds: 20,
          revenue: {
            actual: 76586, budget: 93042, priorMonth: 82840,
            items: [
              { actual: 76586, budget: 92000 },
              { actual: 0,     budget: 0 },
              { actual: 0,     budget: 833 },
              { actual: 0,     budget: 208 },
            ],
          ...
          expenses: {
            actual: 44112, budget: 55488, priorMonth: 59670,
            items: [
              { actual: 38843, budget: 43417 },
              { actual: 2078,  budget: 3333 },
              { actual: 806,   budget: 1083 },
              { actual: 0,     budget: 1829 },
              { actual: 1376,  budget: 1917 },
              { actual: 143,   budget: 1250 },
              { actual: 0,     budget: 542 },
              { actual: 866,   budget: 2784 },
            ],
          },
          occupancy: { actual: 77, budget: 92, priorMonth: 83 },
          noi:       { actual: 32474, budget: 37488, priorMonth: 23170 },
        },
        {
          name: 'Riverton',
          beds: 18,
          revenue: {
            actual: 62064, budget: 73042, priorMonth: 57326,
            items: [
              { actual: 62064, budget: 72000 },
              { actual: 0,     budget: 0 },
              { actual: 0,     budget: 833 },
              { actual: 0,     budget: 208 },
            ],
          ...
          expenses: {
            actual: 49744, budget: 50981, priorMonth: 50934,
            items: [
              { actual: 36726, budget: 37227 },
              { actual: 1720,  budget: 4583 },
              { actual: 193,   budget: 479 },
              { actual: 777,   budget: 1058 },
              { actual: 2033,  budget: 2292 },
              { actual: 4615,  budget: 1033 },
              { actual: 0,     budget: 50 },
              { actual: 7101,  budget: 7858 },
            ],
          },
          occupancy: { actual: 78, budget: 90, priorMonth: 71 },
          noi:       { actual: 12320, budget: 22061, priorMonth: 6392 },
        },
        {
          name: 'Elk Ridge',
          beds: 29,
          revenue: {
            actual: 49465, budget: 89583, priorMonth: 80809,
            items: [
              { actual: 49465, budget: 89583 },
              { actual: 0,     budget: 0 },
              { actual: 0,     budget: 0 },
              { actual: 0,     budget: 0 },
            ],
          ...
          expenses: {
            actual: 49337, budget: 47692, priorMonth: 62098,
            items: [
              { actual: 45602, budget: 32167 },
              { actual: 2285,  budget: 5417 },
              { actual: 20,    budget: 483 },
              { actual: 0,     budget: 1500 },
              { actual: 1230,  budget: 5417 },
              { actual: 54,    budget: 833 },
              { actual: 0,     budget: 167 },
              { actual: 147,   budget: 625 },
            ],
          },
          occupancy: { actual: 55, budget: 100, priorMonth: 90 },
          noi:       { actual: 128, budget: 41683, priorMonth: 18711 },
        },
        {
          name: 'Hearthstone Manor',
          beds: 35,
          revenue: {
            actual: 87784, budget: 121883, priorMonth: 119600,
            items: [
              { actual: 87784, budget: 121883 },
              { actual: 0,     budget: 0 },
              { actual: 0,     budget: 0 },
              { actual: 0,     budget: 0 },
            ],
          ...
          expenses: {
            actual: 60681, budget: 67015, priorMonth: 75678,
            items: [
              { actual: 56304, budget: 44815 },
              { actual: 82,    budget: 9167 },
              { actual: 412,   budget: 880 },
              { actual: 0,     budget: 2083 },
              { actual: 1529,  budget: 4583 },
              { actual: 2352,  budget: 2083 },
              { actual: 0,     budget: 83 },
              { actual: 2,     budget: 3308 },
            ],
          },
          occupancy: { actual: 72, budget: 100, priorMonth: 98 },
          noi:       { actual: 27103, budget: 54868, priorMonth: 43922 },
        },
        {
          name: 'West Jordan',
          beds: 16,
          revenue: {
            actual: 86059, budget: 207000, priorMonth: 123353,
            items: [
              { actual: 83559, budget: 207000 },
              { actual: 0,     budget: 0 },
              { actual: 1500,  budget: 0 },
              { actual: 1000,  budget: 0 },
            ],
          ...
          expenses: {
            actual: 75809, budget: 133188, priorMonth: 87060,
            items: [
              { actual: 61878, budget: 67700 },
              { actual: 9159,  budget: 13039 },
              { actual: 0,     budget: 1150 },
              { actual: 0,     budget: 2951 },
              { actual: 4307,  budget: 6000 },
              { actual: 0,     budget: 2400 },
              { actual: 0,     budget: 150 },
              { actual: 438,   budget: 39598 },
            ],
          },
          occupancy: { actual: 40, budget: 100, priorMonth: 58 },
          noi:       { actual: 10250, budget: 73112, priorMonth: 36293 },
        },
      ],
    },
  ],
