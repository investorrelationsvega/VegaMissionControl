...
const REPORT_CARD_DATA = {
  ...
  periods: [
    ...
    // All values exact to the cent — no rounding
    // ══════════════════════════════════════════════
    {
      month: 'January',
      year: 2026,
      homes: [
        {
          ...
          beds: 20,
          revenue: {
            actual: 82840.15, budget: 93041.67, priorMonth: 80500,
            items: [
              { actual: 82840.15, budget: 92000.00 },
              { actual: 0,        budget: 0 },
              { actual: 0,        budget: 833.34 },
              { actual: 0,        budget: 208.33 },
            ],
          },
          expenses: {
            actual: 59670.32, budget: 55488.42, priorMonth: 48200,
            items: [
              { actual: 42659.32, budget: 43416.67 },
              { actual: 3107.16,  budget: 3333.33 },
              { actual: 1000.05,  budget: 1083.33 },
              { actual: 709.41,   budget: 1829.17 },
              { actual: 1288.09,  budget: 1916.67 },
              { actual: 1491.91,  budget: 1250.00 },
              { actual: 523.12,   budget: 541.67 },
              { actual: 8891.26,  budget: 2117.58 },
            ],
          },
          occupancy: { actual: 83, budget: 92, priorMonth: 85 },
          noi:       { actual: 23169.83, budget: 37487.83, priorMonth: 32300 },
        },
        {
          name: 'Riverton',
          beds: 18,
          revenue: {
            actual: 57325.64, budget: 73041.67, priorMonth: 56200,
            items: [
              { actual: 57325.64, budget: 72000.00 },
              { actual: 0,        budget: 0 },
              { actual: 0,        budget: 833.34 },
              { actual: 0,        budget: 208.33 },
            ],
          ...
          expenses: {
            actual: 50933.68, budget: 50980.83, priorMonth: 42800,
            items: [
              { actual: 36731.94, budget: 37226.66 },
              { actual: 1760.62,  budget: 4583.33 },
              { actual: 295.49,   budget: 479.17 },
              { actual: 1162.67,  budget: 1058.33 },
              { actual: 3544.38,  budget: 2291.67 },
              { actual: 602.24,   budget: 1033.33 },
              { actual: 0,        budget: 50.00 },
              { actual: 6836.34,  budget: 4258.34 },
            ],
          },
          occupancy: { actual: 71, budget: 90, priorMonth: 74 },
          noi:       { actual: 6391.96, budget: 22060.84, priorMonth: 13400 },
        },
        {
          name: 'Elk Ridge',
          beds: 29,
          revenue: {
            actual: 80809.00, budget: 89583.33, priorMonth: 78400,
            items: [
              { actual: 80809.00, budget: 89583.33 },
              { actual: 0,        budget: 0 },
              { actual: 0,        budget: 0 },
              { actual: 0,        budget: 0 },
            ],
          ...
          expenses: {
            actual: 62098.43, budget: 47691.68, priorMonth: 42500,
            items: [
              { actual: 42316.73, budget: 32166.67 },
              { actual: 5525.61,  budget: 5416.67 },
              { actual: 899.32,   budget: 483.33 },
              { actual: 1497.45,  budget: 1500.00 },
              { actual: 3232.45,  budget: 5416.67 },
              { actual: 225.40,   budget: 833.33 },
              { actual: 0,        budget: 166.67 },
              { actual: 8401.47,  budget: 1708.34 },
            ],
          },
          occupancy: { actual: 90, budget: 100, priorMonth: 83 },
          noi:       { actual: 18710.57, budget: 41683.32, priorMonth: 35900 },
        },
        {
          name: 'Hearthstone Manor',
          beds: 35,
          revenue: {
            actual: 119599.60, budget: 121883.17, priorMonth: 112500,
            items: [
              { actual: 119599.60, budget: 121883.17 },
              { actual: 0,         budget: 0 },
              { actual: 0,         budget: 0 },
              { actual: 0,         budget: 0 },
            ],
          ...
          expenses: {
            actual: 75677.85, budget: 67015.41, priorMonth: 51200,
            items: [
              { actual: 54899.36, budget: 44815.00 },
              { actual: 212.92,   budget: 9166.67 },
              { actual: 425.52,   budget: 2546.25 },
              { actual: 1889.66,  budget: 2083.33 },
              { actual: 3899.18,  budget: 4583.33 },
              { actual: 7145.41,  budget: 2083.33 },
              { actual: 0,        budget: 83.33 },
              { actual: 7205.80,  budget: 1654.17 },
            ],
          },
          occupancy: { actual: 98, budget: 100, priorMonth: 89 },
          noi:       { actual: 43921.75, budget: 54867.76, priorMonth: 61300 },
        },
        {
          name: 'West Jordan',
          beds: 16,
          revenue: {
            actual: 123353.09, budget: 207000.00, priorMonth: null,
            items: [
              { actual: 120853.09, budget: 207000.00 },
              { actual: 0,         budget: 0 },
              { actual: 1500.00,   budget: 0 },
              { actual: 1000.00,   budget: 0 },
            ],
          },
          expenses: {
            actual: 87059.66, budget: 133187.66, priorMonth: null,
            items: [
              { actual: 59714.47, budget: 69200.00 },
              { actual: 12909.71, budget: 13038.75 },
              { actual: 436.83,   budget: 1150.00 },
              { actual: 4885.87,  budget: 2201.25 },
              { actual: 6364.43,  budget: 6000.00 },
              { actual: 322.41,   budget: 2400.00 },
              { actual: 0,        budget: 150.00 },
              { actual: 2425.94,  budget: 39047.66 },
            ],
          },
          occupancy: { actual: 58, budget: 100, priorMonth: null },
          noi:       { actual: 36293.43, budget: 73112.34, priorMonth: null },
        },
      ],
    },
